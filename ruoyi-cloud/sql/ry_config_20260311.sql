...
(2,'ruoyi-gateway-dev.yml','DEFAULT_GROUP','spring:\n  data:\n    redis:\n      host: localhost\n      port: 6379\n      password: \n  cloud:\n    gateway:\n      server:\n        webflux:\n          discovery:\n            locator:\n              lowerCaseServiceId: true\n              enabled: true\n          routes:\n            # 认证中心\n            - id: ruoyi-auth\n              uri: lb://ruoyi-auth\n              predicates:\n                - Path=/auth/**\n              filters:\n                # 验证码处理\n                - name: CacheRequestBody\n                  args:\n                    bodyClass: java.lang.String\n                - ValidateCodeFilter\n                - StripPrefix=1\n            # 代码生成\n            - id: ruoyi-gen\n              uri: lb://ruoyi-gen\n              predicates:\n                - Path=/code/**\n              filters:\n                - StripPrefix=1\n            # 定时任务\n            - id: ruoyi-job\n              uri: lb://ruoyi-job\n              predicates:\n                - Path=/schedule/**\n              filters:\n                - StripPrefix=1\n            # 系统模块\n            - id: ruoyi-system\n              uri: lb://ruoyi-system\n              predicates:\n                - Path=/system/**\n              filters:\n                - StripPrefix=1\n            # 文件服务\n            - id: ruoyi-file\n              uri: lb://ruoyi-file\n              predicates:\n                - Path=/file/**\n              filters:\n                - StripPrefix=1\n            # Agent 服务\n            - id: ruoyi-agent\n              uri: lb://ruoyi-agent\n              predicates:\n                - Path=/agent/**\n            # 知识库接口（当前实现位于 ruoyi-agent）\n            - id: ruoyi-kb\n              uri: lb://ruoyi-agent\n              predicates:\n                - Path=/kb/**\n            # 模型服务\n            - id: ruoyi-model\n              uri: lb://ruoyi-model\n              predicates:\n                - Path=/model/**\n            # 对话接口\n            - id: ruoyi-chat\n              uri: lb://ruoyi-agent\n              predicates:\n                - Path=/chat/**\n            # 用户画像接口\n            - id: ruoyi-profile\n              uri: lb://ruoyi-agent\n              predicates:\n                - Path=/profile/**\n            # 简历接口\n            - id: ruoyi-resume\n              uri: lb://ruoyi-agent\n              predicates:\n                - Path=/resume/**\n            # 管理端接口\n            - id: ruoyi-admin\n              uri: lb://ruoyi-agent\n              predicates:\n                - Path=/admin/**\n\n# 安全配置\nsecurity:\n  # 验证码\n  captcha:\n    enabled: true\n    type: math\n  # 防止XSS攻击\n  xss:\n    enabled: true\n    excludeUrls:\n      - /system/notice\n\n  # 不校验白名单\n  ignore:\n    whites:\n      - /auth/logout\n      - /auth/login\n      - /auth/register\n      - /*/v2/api-docs\n      - /*/v3/api-docs\n      - /csrf\n\n# springdoc配置\nspringdoc:\n  webjars:\n    # 访问前缀\n    prefix:\n','68342c65e7b9c551ffcfbb2076ed6cda','2020-05-14 14:17:55','2026-03-10 10:57:46','nacos_namespace_migrate','192.168.137.1','','','网关模块',NULL,NULL,'yaml',NULL,''),
...
UPDATE config_info
SET content = REPLACE(REPLACE(content, 'host: localhost', 'host: ruoyi-redis'), 'password: \n', 'password: change-redis-password\n')
WHERE data_id IN ('ruoyi-gateway-dev.yml','ruoyi-auth-dev.yml','ruoyi-system-dev.yml','ruoyi-gen-dev.yml','ruoyi-job-dev.yml');
UPDATE config_info
SET content = REPLACE(REPLACE(REPLACE(content, 'jdbc:mysql://localhost:3306/ry-cloud', 'jdbc:mysql://ruoyi-mysql:3306/ry-cloud'), 'username: root', 'username: career_app'), 'password: password', 'password: change-business-db-password')
WHERE data_id IN ('ruoyi-system-dev.yml','ruoyi-gen-dev.yml','ruoyi-job-dev.yml');
UPDATE config_info
SET content = REPLACE(content, 'gatewayUrl: http://localhost:8080/${spring.application.name}', 'gatewayUrl: http://ruoyi-gateway:8080/${spring.application.name}')
WHERE data_id IN ('ruoyi-system-dev.yml','ruoyi-gen-dev.yml','ruoyi-job-dev.yml');
...
('ruoyi-agent-dev.yml', 'DEFAULT_GROUP', 'spring:\n  data:\n    redis:\n      host: ruoyi-redis\n      port: 6379\n      password: change-redis-password\n  datasource:\n    dynamic:\n      primary: master\n      lazy: true\n      datasource:\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://ruoyi-mysql:3306/ry-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: career_app\n          password: change-business-db-password\n        vector:\n          driver-class-name: org.postgresql.Driver\n          url: jdbc:postgresql://ruoyi-postgres:5432/ry_vector\n          username: vector_user\n          password: change-postgres-password\n\nmybatis:\n  typeAliasesPackage: com.ruoyi.agent.domain\n  mapperLocations: classpath:mapper/**/*.xml\n', MD5('ruoyi-agent-dev'), NOW(), NOW(), 'nacos', '127.0.0.1', '', '', 'Agent服务', NULL, NULL, 'yaml', NULL, ''),
('ruoyi-model-dev.yml', 'DEFAULT_GROUP', 'spring:\n  data:\n    redis:\n      host: ruoyi-redis\n      port: 6379\n      password: change-redis-password\n  datasource:\n    dynamic:\n      primary: master\n      datasource:\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://ruoyi-mysql:3306/ry-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: career_app\n          password: change-business-db-password\n\nmybatis:\n  typeAliasesPackage: com.ruoyi.model.domain\n  mapperLocations: classpath:mapper/**/*.xml\n', MD5('ruoyi-model-dev'), NOW(), NOW(), 'nacos', '127.0.0.1', '', '', '模型服务', NULL, NULL, 'yaml', NULL, ''),
('ruoyi-knowledge-dev.yml', 'DEFAULT_GROUP', 'spring:\n  datasource:\n    dynamic:\n      primary: master\n      datasource:\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://ruoyi-mysql:3306/ry-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: career_app\n          password: change-business-db-password\n\nmybatis:\n  typeAliasesPackage: com.ruoyi.knowledge.domain\n  mapperLocations: classpath:mapper/**/*.xml\n', MD5('ruoyi-knowledge-dev'), NOW(), NOW(), 'nacos', '127.0.0.1', '', '', '知识库服务', NULL, NULL, 'yaml', NULL, '');
UPDATE config_info SET md5 = MD5(content), gmt_modified = NOW() WHERE data_id LIKE 'ruoyi-%-dev.yml';
